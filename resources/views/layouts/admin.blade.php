...
>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="{{asset('dist/img/user7-128x128.jpg')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
            ...
            <div class="sidebar">
                <div>
                    ...
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                        ...
                        <div class="info">
                            <a href="#" class="d-block"> داليا أحمد</a>
                        </div>
                    </div>
        ...
        <footer class="main-footer">
            <strong>copyrights reserved &copy;</strong>
        </footer>
    </div>
    <!-- ./wrapper -->
    ...
    <!-- jQuery -->
    <script src="{{asset('dist/jquery/jquery.min.js"></scr')}}ipt>
    <!-- Bootstrap 4 -->
